### 인터넷
#### 1. 인터넷의 등장배경
 - 1950년대 당시 선진국들은 핵에 대한 위협을 느끼고 있었는데, 미국은 핵 공격을 받았을 시 입을 피해에 대해서 시뮬레이션을 해본 결과 ‘통신’ 부분에서 가장 취약하다는 것을 깨달았다. 당시 통신은 중앙집중형으로 핵 공격을 받는 경우 통신이 마비되는 것이었다.
 - 이에 대한 해결책으로 나온 것이 ‘인터넷’인데, **인터넷은 통신이 중앙집중적이지 않고 분산**되어있는 특징이 있었기 때문이다.
...
#### 2. 인터넷의 개념
  ...
  - 인터넷은 컴퓨터간(최소 2대 이상) 데이터를 주고 받을 수 있는 일종의 컴퓨터 통신망(네트워크)이다.
